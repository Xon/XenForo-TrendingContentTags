...
class SV_TrendingContentTags_XenForo_Model_Tag extends XFCP_SV_TrendingContentTags_XenForo_Model_Tag
{
    ...
    protected function _setupState()
    {
        ...
        // cron-task runs every ~10 minutes, ensure the samples will last long enough even if a instance is missed
        $this->sv_tagTrending_key_expiry = $this->sv_tagTrending_sampleInterval + 25 * 60;
    }
